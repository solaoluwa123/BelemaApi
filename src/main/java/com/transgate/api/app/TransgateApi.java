...
@SpringBootApplication(scanBasePackages = "com.transgate.api")
@EnableScheduling
...
//    @Scheduled(fixedRate = 10000) // Run every day (10000 milliseconds)
    ...
    /** Saturday 00:05 Africa/Lagos — generate commissions for the Sun–Fri week that just closed. */
    @Scheduled(cron = "0 5 0 * * SAT", zone = "Africa/Lagos")
