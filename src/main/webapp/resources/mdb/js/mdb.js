                          ...
                          function r() {
                              function t(t) {
                                  ...
                                  if ("scroll" === T) {
                                      ...
                                      y)) {
                                          ...
                                          if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                              ((c.display !== n && null !== c.display && "none" !== c.display) || (c.visibility !== n && "hidden" !== c.visibility)) && /opacity|filter/.test(E) && !W && 0 !== $ && (W = 0),
                                                  c._cacheValues && O && O[E]
                                                      ? (W === n && (W = O[E].endValue + O[E].unitType), (N = a(r).rootPropertyValueCache[z]))
                                                      : b.Hooks.registered[E]
                                                      ? W === n
                                                          ? ((N = b.getPropertyValue(r, z)), (W = b.getPropertyValue(r, E, N)))
                                              ...
                                              if (
                                                  ...
                                                  (W = parseFloat(W) || 0),
                                                  ($ = parseFloat($) || 0),
                                                  "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? (($ /= 100), (B = "em")) : /^scale/.test(E) ? (($ /= 100), (B = "")) : /(Red|Green|Blue)$/i.test(E) && (($ = ($ / 100) * 255), (B = ""))),
                                                  /[\/*]/.test(Y))
                                              )
                                                  B = j;
                                              else if (j !== B && 0 !== W)
                                              ...
                                              (d[E] = { rootPropertyValue: N, startValue: W, currentValue: W, endValue: $, unitType: B, easing: V }), v.debug && console.log("tweensContainer (" + E + "): " + JSON.stringify(d[E]), r);
                                  ...
                                  d.element &&
                                      ...
                                      (a(r).isAnimating = !0),
                                      S === C - 1 ? (v.State.calls.push([R, g, c, null, P.resolver]), !1 === v.State.isTicking && ((v.State.isTicking = !0), l())) : S++);
                              }
                              var o,
                                  r = this,
                    ...
                    function (t, e, i) {
                        ...
                        e.exports = {
                            ...
                            update: function (t, e, i) {
                                ...
                                function z(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.fullWidth ? l : A), (t.right = t.fullWidth ? e - c : A + k), (t.top = V), (t.bottom = V + t.height), (V = t.bottom))
                                        : ((t.left = $), (t.right = $ + t.width), (t.top = _), (t.bottom = _ + C), ($ = t.right));
                                }
                            },
                        };
                    },
                                    ...
                                    if (i.display) {
                                        ...
                                        if (
                                            (a.each(g, function (n, o) {
                                                if (!a.isNullOrUndef(n.label)) {
                                                    ...
                                                    if (m) {
                                                        var W = w + V;
                                                        "bottom" === i.position
                                                            ? (($ = f ? "middle" : "top"), (F = f ? "right" : "center"), (L = e.top + W))
                                                            : (($ = f ? "middle" : "bottom"), (F = f ? "left" : "center"), (L = e.bottom - W));
                                                        ...
                                                        var N,
                                                            H = "left" === i.position;
                                                        s.mirror ? ((F = H ? "left" : "right"), (N = V)) : ((F = H ? "right" : "left"), (N = w + V)), (E = H ? e.right - N : e.left + N);
                                                        var B = l(e, o, h.offsetGridLines && g.length > 1);
                                                        B < e.top && (u = "rgba(0,0,0,0)"), (B += a.aliasPixel(c)), (L = e.getPixelForTick(o) + s.labelOffset), (v = I), (b = A), (k = t.left), (S = t.right + P), (y = x = C = D = B);
                                                    }
                                                    T.push({
                                                        tx1: v,
                                                        ty1: y,
                                            ...
                                            if (m) (D = e.left + (e.right - e.left) / 2), (E = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top);
                                                ...
                                                (D = F ? e.left + R + S.top : e.right - R - S.top), (E = e.top + (e.bottom - e.top) / 2), (L = F ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (h.drawBorder) {
                                            ...
                                            m ? ((W = z = "top" === i.position ? e.bottom : e.top), (W += N), (z += N)) : (($ = V = "left" === i.position ? e.right : e.left), ($ += N), (V += N)),
                                                o.beginPath(),
                                                o.moveTo($, W),
                                                o.lineTo(V, z),
                                                o.stroke();
                                    ...
                                    o > 0 && (o = 0),
                                        ...
                                        "left" === this.options.edge
                                            ? ((this.menuOut && i <= 0.3) || i < -0.5
                                                  ...
                                                  : (!this.menuOut || i > 0.3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - 10, o], "200"), this.hideSidenavOverlay()),
                                            ...
                                            : (!this.menuOut || i < -0.3) &&
                                              (this.enableScrolling(), this.translateMenuX([this.options.menuWidth + 10, a], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({ width: "10px", right: 0, left: "" }));
                                }
                            },
                        },
                        {
                                    ...
                                    n > 0 && (n = 0),
                                        ...
                                        "left" === this.options.edge
                                            ? ((this.menuOut && e <= 0.3) || e < -0.5
                                                  ...
                                                  : (!this.menuOut || e > 0.3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - 10, n], "200"), this.hideSidenavOverlay()),
                                              this.$dragTarget.css({ width: "10px", right: "", left: 0 }))
                                            : (this.menuOut && e >= -0.3) || e > 0.5
                                            ? (this.translateMenuX([0, o], "300"), this.showSidenavOverlay(), this.$dragTarget.css({ width: "50%", right: "", left: 0 }))
                                            : (!this.menuOut || e < -0.3) &&
                                              (this.enableScrolling(), this.translateMenuX([this.options.menuWidth + 10, o], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({ width: "10px", right: 0, left: "" }));
                                }
                            },
                        },
                        {
                ...
                function e(i, n) {
                    _classCallCheck(this, e),
                        ...
                        (this.$materialSelect = t(
                            '<input type="text" class="select-dropdown" readonly="true" '.concat(this.$nativeSelect.is(":disabled") ? "disabled" : "", ' data-activates="select-options-').concat(this.uuid, '" value=""/>')
                        )),
        ...
        function M(t, e) {
            ...
            if (e.twelvehour)
                for (E = 0; E < 12; E += e.hourstep)
                    (L = $.clone()), (R = (E / 6) * Math.PI), (F = b), L.css("font-size", "140%"), L.css({ left: y + Math.sin(R) * F - w, top: y - Math.cos(R) * F - w }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, z);
            else
                for (E = 0; E < 24; E += e.hourstep) {
                    (L = $.clone()), (R = (E / 6) * Math.PI);
                    var V = E > 0 && E < 13;
                    (F = V ? x : b), L.css({ left: y + Math.sin(R) * F - w, top: y - Math.cos(R) * F - w }), V && L.css("font-size", "120%"), L.html(0 === E ? "00" : E), p.append(L), L.on(u, z);
                }
            var W = Math.max(e.minutestep, 5);
            for (E = 0; E < 60; E += W)
                for (E = 0; E < 60; E += 5) (L = $.clone()), (R = (E / 30) * Math.PI), L.css({ left: y + Math.sin(R) * b - w, top: y - Math.cos(R) * b - w }), L.css("font-size", "140%"), L.html(g(E)), M.append(L), L.on(u, z);
            function z(t, i) {
                var n = l.offset(),
                    o = /^touch/.test(t.type),
                    r = n.left + y,
    ...
    (function (t, e) {
        ...
        return function (t, e, i, n) {
            ...
            var s,
                ...
                Rt = null,
                Ft = function () {
                    Rt && (o.unbind(document, "mousemove", Ft), o.addClass(t, "pswp--has_mouse"), (r.mouseUsed = !0), St("mouseUsed")),
                ...
                Kt = {
                    ...
                    init: function () {
                        if (!s && !l) {
                            ...
                            (a.framework = o),
                                ...
                                (m = { resize: a.updateSize, scroll: Bt, keydown: Nt, click: Ht });
                    ...
                    goTo: function (t) {
                        var e = (t = wt(t)) - u;
                        (mt = e), (u = t), (a.currItem = We(u)), (ht -= e), _t(ft.x * ht), Ut(), (et = !1), a.updateCurrItem();
                    },
                    next: function () {
                        a.goTo(u + 1);
                    },
                    ...
                    updateCurrItem: function (t) {
                        if (0 !== mt) {
                            var e,
                                i = Math.abs(mt);
                            if (!(t && 2 > i)) {
                                (a.currItem = We(u)), (bt = !1), St("beforeChange", mt), i >= 3 && ((h += mt + (mt > 0 ? -3 : 3)), (i = 3));
                                for (var n = 0; i > n; n++)
                                    mt > 0
                    ...
                    return (
                        ...
                        (tt
                            ? "h" !== it ||
                              ...
                              X ||
                              (c
                                  ? (l > J.min[t] && ((i = r.panEndFriction), J.min[t], (n = J.min[t] - ct[t])), (0 >= n || 0 > d) && ze() > 1 ? ((s = u), 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))
                                  : (l < J.max[t] && ((i = r.panEndFriction), J.max[t], (n = ct[t] - J.max[t])), (0 >= n || d > 0) && ze() > 1 ? ((s = u), d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)))
                            : (s = u),
                        "x" !== t)
                        ...
                        if (!B || "mousedown" !== t.type) {
                            ...
                            (K = null),
                                ...
                                !Z &&
                                    ...
                                    !et &&
                                    !Q &&
                                    ((v = g), (X = !1), (Z = Y = !0), (lt.y = lt.x = 0), Et(ct, ut), Et(Zt, i[0]), Et(Gt, i[1]), be(Zt, Gt, de), (ue.x = Math.abs(de.x) - ut.x), (ue.y = Math.abs(de.y) - ut.y), (G = he(Zt, Gt)));
                        }
                    }
                },
                Pe = function (t) {
                ...
                Ie = function () {
                    if (K) {
                        var t = K.length;
                        if (0 !== t)
                            if ((Et(Zt, K[0]), (Jt.x = Zt.x - te.x), (Jt.y = Zt.y - te.y), Z && t > 1)) {
                                if (
                                    ((te.x = Zt.x),
                                    (te.y = Zt.y),
                                    !Jt.x &&
                                ...
                                0 > n && (n = 0), be(Zt, Gt, se), (lt.x += se.x - de.x), (lt.y += se.y - de.y), Et(de, se), (ut.x = Dt("x", i)), (ut.y = Dt("y", i)), (N = i > g), (g = i), It();
                            } else {
                                if (!it) return;
                                if ((nt && ((nt = !1), Math.abs(Jt.x) >= 10 && (Jt.x -= K[0].x - ee.x), Math.abs(Jt.y) >= 10 && (Jt.y -= K[0].y - ee.y)), (te.x = Zt.x), (te.y = Zt.y), 0 === Jt.x && 0 === Jt.y)) return;
                    ...
                    var t,
                        ...
                        i = {
                            ...
                            calculateSwipeSpeed: function (n) {
                                oe.length > 1 ? ((t = Mt() - W + 50), (e = oe[oe.length - 2][n])) : ((t = Mt() - V), (e = ee[n])),
                ...
                publicMethods: {
                    initGestures: function () {
                        ...
                        (A = $.pointerEvent) && $.touch && ($.touch = !1),
                            ...
                            (m[T] = Ae),
                            P && (m[P] = m[T]),
                            $.touch && ((f += " mousedown"), (p += " mousemove mouseup"), (m.mousedown = m[S]), (m.mousemove = m[M]), (m.mouseup = m[T])),
            ...
            var Re,
                ...
                Ne = function (e, i, n, s) {
                    var l;
                    Re && clearTimeout(Re), (Ve = !0), ($e = !0), e.initialLayout ? ((l = e.initialLayout), (e.initialLayout = null)) : (l = r.getThumbBoundsFn && r.getThumbBoundsFn(u));
                ...
                Ke = function () {
                    if (Be.length) {
                        for (var t, e = 0; e < Be.length; e++) (t = Be[e]).holder.index === t.index && Xe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                        Be = [];
                    }
                };
            xt("Controller", {
                    ...
                    setContent: function (t, e) {
                        ...
                        if (l) {
                            ...
                            if ((!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : (c.innerHTML = l.html)), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded))
                                    ...
                                    ((l.loadComplete = function (i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended
                                                    ? !Ve && i.placeholder && ((i.placeholder.style.display = "none"), (i.placeholder = null))
                                                    : $.transform && (et || Ve)
                                ...
                                l.loading || qe(l), a.allowProgressiveImg() && (!$e && $.transform ? Be.push({ item: l, baseDiv: c, img: l.img, index: e, holder: t }) : Xe(0, l, c, l.img, 0, !0));
                            }
        ...
        return function (t, e) {
            var i,
                ...
                M = function (t) {
                    ...
                    for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < W.length; a++) (i = W[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), (n = !0));
                    if (n) {
                                ...
                                if (n)
                                    for (var a = n.length, r = 0; a > r; r++) {
                                        ...
                                        for (var s = 0; s < W.length; s++)
                                            (o = W[s]), i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"));
                                    }
                            };
                        a(n.children);
                            ...
                            (function (e, i) {
                                ...
                                e.settings.useBothWheelAxes
                                    ? e.scrollbarYActive && !e.scrollbarXActive
                                        ? (r(t, "top", l ? t.scrollTop - l * e.settings.wheelSpeed : t.scrollTop + s * e.settings.wheelSpeed), (n = !0))
                                        : e.scrollbarXActive && !e.scrollbarYActive && (r(t, "left", s ? t.scrollLeft + s * e.settings.wheelSpeed : t.scrollLeft - l * e.settings.wheelSpeed), (n = !0))
                                    : (r(t, "top", t.scrollTop - l * e.settings.wheelSpeed), r(t, "left", t.scrollLeft + s * e.settings.wheelSpeed)),
                                a(t),
                                (n =
                                    n ||
                                    (function (i, n) {
                                    ...
                                    !x &&
                                        ...
                                        e.settings.swipeEasing &&
                                            ...
                                            (b = setInterval(function () {
                                                return o.get(t) && (y.x || y.y) ? (Math.abs(y.x) < 0.01 && Math.abs(y.y) < 0.01 ? void clearInterval(b) : (l(30 * y.x, 30 * y.y), (y.x *= 0.8), void (y.y *= 0.8))) : void clearInterval(b);
                                            }, 10))));
                                }
                                var g = {},
                                    v = 0,
                                    ...
                                    w = !1;
                                i
                                    ? (e.event.bind(window, "touchstart", c), e.event.bind(window, "touchend", u), e.event.bind(t, "touchstart", p), e.event.bind(t, "touchmove", f), e.event.bind(t, "touchend", m))
                                    : n &&
                                      (window.PointerEvent
                                          ? (e.event.bind(window, "pointerdown", c), e.event.bind(window, "pointerup", u), e.event.bind(t, "pointerdown", p), e.event.bind(t, "pointermove", f), e.event.bind(t, "pointerup", m))
                                          : window.MSPointerEvent &&
                                            (e.event.bind(window, "MSPointerDown", c), e.event.bind(window, "MSPointerUp", u), e.event.bind(t, "MSPointerDown", p), e.event.bind(t, "MSPointerMove", f), e.event.bind(t, "MSPointerUp", m)));
                        ...
                        (i.containerWidth = t.clientWidth),
                            ...
                            !i.settings.suppressScrollX && i.containerWidth + i.settings.scrollXMarginOffset < i.contentWidth
                                ? ((i.scrollbarXActive = !0),
                                  ...
                                  (i.scrollbarXLeft = o.toInt(((i.negativeScrollAdjustment + t.scrollLeft) * (i.railXWidth - i.scrollbarXWidth)) / (i.contentWidth - i.containerWidth))))
                            ...
                            !i.settings.suppressScrollY && i.containerHeight + i.settings.scrollYMarginOffset < i.contentHeight
                                ? ((i.scrollbarYActive = !0),
                                  ...
                                  (i.scrollbarYTop = o.toInt((t.scrollTop * (i.railYHeight - i.scrollbarYHeight)) / (i.contentHeight - i.containerHeight))))
                            ...
                            (function (t, e) {
                                ...
                                e.isScrollbarYUsingRight
                                    ...
                                    r.css(e.scrollbarX, { left: e.scrollbarXLeft, width: e.scrollbarXWidth - e.railBorderXWidth }),
                ...
                var w =
                    ...
                    S = function (t) {
                        ...
                        for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
                            if (("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new C(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r))
                                return r;
                        return t;
                    };
